...
def preprocess_serialized_womd_data(
  ...
  # print('#'*100)
  # # Define a function that converts hexadecimal to int32
  # hex_string = deserialized['roadgraph_samples/dir'][0]
  # # print(tf.strings.to_number(hex_string, out_type=tf.float32))
  # print(hex_string[0])
