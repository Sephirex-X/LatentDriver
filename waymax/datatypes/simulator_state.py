...
class SimulatorState:
  ...
  scenario_id: jax.typing.ArrayLike = None
  @property
  def _scenario_id(self) -> jnp.ndarray:
    """The scenario id of the current simulation."""
    return jnp.array(self.scenario_id)
  @property
...
def update_state_by_log(
    state: SimulatorState, num_steps: int=1
) -> SimulatorState:
